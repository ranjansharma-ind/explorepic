    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-center max-w-[540px] mx-auto mb-16">
          ...
          <h2 className="text-4xl md:text-3xl tracking-widest uppercase font-extrabold mt-6 text-center text-neutral-900 dark:text-white transition-colors">
            What our users say
          </h2>
...
export default function App() {
  return (
    <div className="w-100 min-h-screen bg-white dark:bg-neutral-950 transition-colors duration-300 flex flex-col justify-center relative">
      <TestimonialsSection />
    </div>
  );
}
