...
export default function ServiceFooter() {
  return (
    ...
    <div className="w-full bg-customYellow/40 py-5 px-4 font-sans border-t border-amber-100/50">
      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
        ...
        */}
        <div className="flex flex-wrap justify-center gap-x-12 gap-y-5 max-w-5xl w-full">
